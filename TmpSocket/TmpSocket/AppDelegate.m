...
- (void) netWorkChange: (NSNotification*)note {
    ...
    SocketHelper *soctket = [SocketHelper sharedSocket];
    [soctket connectToHost];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TmpSocket" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"TmpSocket.sqlite"];
